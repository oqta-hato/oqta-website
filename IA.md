# OQTA サービスサイト 新IA（情報設計）v1

> 【v1 更新 2026-05-29】範囲＝**OQTAサービス専用**（INORI企業サイトは別立て）。役割＝**深度ファネル**（新規獲得でなく“半理解者”の理解/所属を深める）。トーン＝**孤高・コノサー**（煽らない・口コミのみ・広告/インフル無し）。お祈りマップ(inoree.world)は**OQTA機能として組込み**。目玉＝年度版**勧進帳/提灯**。体験入口＝**Androidレシーバー**（京都QRはsunset）。応援＝**奉納フレーミング**。関わりしろの詳細→ [[ENGAGEMENT.md]]。
